...
ALTER TABLE KHOA ADD
	CONSTRAINT K_TRGKHOA_FK FOREIGN KEY (TRGKHOA) REFERENCES GIAOVIEN (MAGV)
...
-- Add data GIANGDAY truoc khong duoc
...
ALTER TABLE KETQUATHI ADD
	CONSTRAINT KQT_MAHV_MAMH_LANTHI_PK PRIMARY KEY (MAHV,MAMH,LANTHI),
	CONSTRAINT KQT_MAMH_FK FOREIGN KEY (MAMH) REFERENCES MONHOC(MAMH)
...
ALTER TABLE DIEUKIEN ADD
	...
	CONSTRAINT DK_MAMH_TRUOC_FK FOREIGN KEY (MAMH_TRUOC) REFERENCES MONHOC(MAMH)
...
ALTER TABLE LOP ADD
	CONSTRAINT L_MAGVCN_FK FOREIGN KEY (MAGVCN) REFERENCES GIAOVIEN (MAGV)

ALTER TABLE MONHOC ADD
	CONSTRAINT MH_MAKHOA_FK FOREIGN KEY (MAKHOA) REFERENCES KHOA (MAKHOA)
...
ALTER TABLE KETQUATHI ADD
	CONSTRAINT KQT_MAHV_FK FOREIGN KEY (MAHV) REFERENCES HOCVIEN (MAHV)

ALTER TABLE LOP ADD
	CONSTRAINT L_TRGLOP_FK FOREIGN KEY (TRGLOP) REFERENCES HOCVIEN (MAHV)
